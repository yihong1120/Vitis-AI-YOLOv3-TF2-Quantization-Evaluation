...
###### generate prediction ######
python eval.py --model_path=${WEIGHTS} --anchors_path=${ANCHOR} --classes_path=${CLASSES} --model_input_shape=416x416 --nms_iou_threshold=${IOU_THRESH} --conf_threshold=0.001 --annotation_file=${ANNO_FILE} --save_result
